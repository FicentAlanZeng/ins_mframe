...
#ifndef MODULEUI_SWIFT_H
#define MODULEUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="moduleUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8moduleUI27INS_BaseTableViewController")
@interface INS_BaseTableViewController : INS_BaseViewController <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8moduleUI11INS_MSToast")
@interface INS_MSToast : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC8moduleUI17INS_MSToastConfig")
@interface INS_MSToastConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



SWIFT_CLASS("_TtC8moduleUI28INS_NavigationViewController")
@interface INS_NavigationViewController : UINavigationController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8moduleUI15INS_ThemeCenter")
@interface INS_ThemeCenter : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
