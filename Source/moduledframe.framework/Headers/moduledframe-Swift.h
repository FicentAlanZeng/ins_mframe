...
#ifndef MODULEDFRAME_SWIFT_H
#define MODULEDFRAME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="moduledframe",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC12moduledframe20INS_ApiCourseService")
@interface INS_ApiCourseService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12moduledframe17INS_ConfigManager")
@interface INS_ConfigManager : NSObject
...
SWIFT_CLASS("_TtC12moduledframe18INS_RequestBuilder")
@interface INS_RequestBuilder : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
- (INS_RequestBuilder * _Nonnull)setUrlParameters:(NSDictionary<NSString *, id> * _Nullable)urlParameters SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12moduledframe15INS_RequestTask")
@interface INS_RequestTask : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12moduledframe16INS_RetrofitUtil")
...
SWIFT_CLASS("_TtC12moduledframe21INS_SafeBoolTransform")
@interface INS_SafeBoolTransform : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12moduledframe20INS_SafeDicTransform")
@interface INS_SafeDicTransform : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// 在ObjectMapper映射过程中，将任何数据类型安全的转换成String。用法: foo <- (map[“foo”], SafeStringTransform()), 元组的第二个参数将map中的“foo”强制转换成String
SWIFT_CLASS("_TtC12moduledframe23INS_SafeStringTransform")
@interface INS_SafeStringTransform : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
